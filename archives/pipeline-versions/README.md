...
현재 실행 버전은 저장소 루트의 [`sprite_pipeline_fastapi_full_v8.zip`](../../sprite_pipeline_fastapi_full_v8.zip)입니다. 이 폴더는 이전 버전의 재현과 회귀 비교를 위한 보관소이며, 현재 RunPod 설치에는 사용하지 않습니다.
...
| V7 | [sprite_pipeline_fastapi_full_v7.zip](sprite_pipeline_fastapi_full_v7.zip) | `460534a6bbc483ad7ad91dfc0fcacea20e6afdfcb6480b5dd365fa7a95698f81` | closed loop, 위치 안정화와 다중 캐릭터 종단 검증 baseline |
