...
- [2026-08-23 V9 동물 4방향 GPU 실생성 실패](V9_ANIMAL_GPU_TEST_FAILURES_2026-08-23.md) — 동물 독립 라우팅은 작동했지만, 올바른 4방향 돼지·양·공룡 실제 렌더가 모두 V9 QC를 통과하지 못했다. V9 전체를 기각하지 않고 실제 실패 산출물을 보존한다.
